...
class Settings(BaseSettings):
    ...
    downloads_dir: Optional[Path] = Field(default=None, description="Directory to monitor for completed SABnzbd downloads.")
    library_dir: Optional[Path] = Field(default=None, description="Destination for processed downloads.")
    staging_dir: Optional[Path] = Field(default=None, description="Temporary processing area before moving downloads into the library.")
